      ...
      <div className="relative max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-14 px-10 z-10">
        ...
        <div>
          ...
          <div className="flex gap-6">
            ...
            >
              <Facebook className="w-6 h-6 text-sky-800" />
            </a>

            {/* Instagram */}
            <a
              href="https://www.instagram.com/kussy_pee?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 rounded-full bg-sky-100 hover:bg-sky-200 transition transform hover:scale-110 shadow-sm cursor-pointer"
            >
              <Instagram className="w-6 h-6 text-sky-800" />
            </a>
            ...
            <a
              ...
              className="p-2 rounded-full bg-sky-100 hover:bg-sky-200 transition transform hover:scale-110 shadow-sm cursor-pointer"
            >
              <Phone className="w-6 h-6 text-sky-800" />
            </a>
          </div>
        </div>
